...
item1 = Item.create(user: user3, name: 'Sabre Laser rouge', description: "Voici mon sabre laser rouge, remis en main propre par le Sénateur Palpatine. Il a été un allié important dans ma vie du côté obscure de la Force. Attention, il est coupant !", price: '215 €', category: 'armes', univers:'Star Wars', poster_url: 'https://cdn2.unrealengine.com/fortnite-darth-vaders-lightsaber-1900x600-fa4602e83bd8.jpg', address: "Marseille")
